        ...
        <div class="container">
            <div class="footer-widget-wrapper">
                <div class="row justify-content-between">
                    @if(isset($data))
                    @foreach($data as $d)
                    <div class="col-xl-1 col-lg-2 col-md-6 col-12 footer-widget" style="width: 10%">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="{{'/'.$d->link}}">{{$d->name}}</a></li>
                            </ul>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            <h4 class="footer-logo">
                                ...
                                <a href="/"><img src="{{asset($image->name)}}" alt="{{asset('website/img/logo.png')}}" style="border-radius: 2%;"></a>
                            </h4>
