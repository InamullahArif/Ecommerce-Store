                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    <h3>{!! __(!empty($roles) ? 'Update Role' : 'Add New Role') !!}</h3>
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <div class="text-tiny">{!! __(!empty($roles) ? 'Update Role' : 'Add New Role') !!}</div>
                                        </li>
                                    </ul>
                                </div>
                                {{-- {{dd($roles)}} --}}
                                <!-- create-roles -->
                                <form class="form-create-role" id="addRole" name="addRole" method="POST" enctype="multipart/form-data" action="{{ !empty($roles['id']) ? route('roles.update', $roles['id']) : route('roles.store') }}">
                                  @csrf
                                  @if(!empty($roles['id']))
                                        @method('PUT')
                                    @endif
                                    <div class="wg-box mb-24">
                                        <fieldset class="name">
                                            ...
                                            @else value="{{ old('name') }}" @endif name="name" tabindex="0" value="" aria-required="true" required="" style="margin-bottom: 6px">
                                            @error('name')
