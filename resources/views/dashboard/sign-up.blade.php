...
<head>
    ...
    <!-- Theme Style -->
    <link rel="stylesheet" type="text/css" href="dashboard/animate.min.css">
    <link rel="stylesheet" type="text/css" href="dashboard/animation.css">
    <link rel="stylesheet" type="text/css" href="dashboard/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="dashboard/bootstrap-select.min.css">
    <link rel="stylesheet" type="text/css" href="dashboard/style.css">



    <!-- Font -->
    <link rel="stylesheet" href="dashboard/font/fonts.css">

    <!-- Icon -->
    <link rel="stylesheet" href="dashboard/icon/style.css">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="dashboard/images/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="dashboard/images/favicon.png">
            ...
            <div class="wrap-login-page sign-up">
                <div class="flex-grow flex flex-column justify-center gap30">
                    ...
                    <div class="login-box">
                        ...
                        <form class="form-login flex flex-column gap24" id="registerForm" name="registerForm" method="POST" enctype="multipart/form-data" action="{{ route('register123') }}">
                            @csrf
                            <fieldset class="name">
                                <div class="body-title mb-10">Your username <span class="tf-color-1">*</span></div>
                                <div class="flex gap10">
                                    <input class="flex-grow" type="text" placeholder="Name" name="name" tabindex="0" value="" aria-required="true" required="">
