   ...
   <div class="section-menu-left">
    ...
    <div class="center">
                ...
                <li class="menu-item has-children active">
                    ...
                    <ul class="sub-menu" style="display: block;">
                        <li class="sub-menu-item">
                            <a href="/dashboardOne" class="active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="sub-menu-item">
                            <a href="/permissions" class="">
                                <div class="text">Assign permissions to roles</div>
                            </a>
                        </li>
                        @endcan
                        @can('assign_user')
                        <li class="sub-menu-item">
                            <a href="/permissions/user" class="">
                                <div class="text">Assign permissions to users</div>
                            </a>
                        </li>
                        @endcan
                    </ul>
        ...
        <div class="center-item">
            <div class="center-heading">Website</div>
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="/navbar" class="">
        ...
        <div class="center-item">
            <div class="center-heading">All Logs</div>
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="/logActivity" class="">
                        <div class="icon"><i class="icon-help-circle"></i></div>
                        <div class="text">Activity Logs</div>
                    </a>
                </li>
            </ul>
        </div>
