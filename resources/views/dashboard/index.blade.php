                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>{{number_format($orders['total_orders_last_year'], 0, '.', ',')}}</h4>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>{{ number_format($orders['price'], 0, '.', ',') }}</h4>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>{{number_format($orders['paid_orders'], 0, '.', ',')}}</h4>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>{{number_format($orders['total_visitors'], 0, '.', ',')}}</h4>
                            </div>
                        </div>
                        {{-- <div class="box-icon-trending up">
                            <i class="icon-trending-up"></i>
