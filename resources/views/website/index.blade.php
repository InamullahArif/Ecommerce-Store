...
<main id="MainContent" class="content-for-layout">
    ...
    <div class="slideshow-section position-relative">
        <div class="slideshow-active activate-slider" data-slick='{
            ...
            <div class="slide-item slide-item-bag position-relative">
                <img class="slide-img d-none d-md-block" src="website/img/slideshow/f1.jpg" alt="slide-1">
                <img class="slide-img d-md-none" src="website/img/slideshow/f1-m.jpg" alt="slide-1">
            ...
            <div class="slide-item slide-item-bag position-relative">
                <img class="slide-img d-none d-md-block" src="website/img/slideshow/f2.jpg" alt="slide-2">
                <img class="slide-img d-md-none" src="website/img/slideshow/f2-m.jpg" alt="slide-2">
                <div class="content-absolute content-slide">
                    <div class="container height-inherit d-flex align-items-center justify-content-end">
            ...
            <div class="slide-item slide-item-bag position-relative">
                <img class="slide-img d-none d-md-block" src="website/img/slideshow/f3.jpg" alt="slide-3">
                <img class="slide-img d-md-none" src="website/img/slideshow/f3-m.jpg" alt="slide-3">
                <div class="content-absolute content-slide">
            ...
            <div class="container">
                <div class="row justify-content-center trusted-row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="trusted-badge rounded p-0">
                            <div class="trusted-icon">
                                <img class="icon-trusted" src="website/img/trusted/1.png" alt="icon-1">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="trusted-badge rounded p-0">
                            <div class="trusted-icon">
                                <img class="icon-trusted" src="website/img/trusted/2.png" alt="icon-2">
                            </div>
                            <div class="trusted-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="trusted-badge rounded p-0">
                            <div class="trusted-icon">
                                <img class="icon-trusted" src="website/img/trusted/3.png" alt="icon-3">
                            </div>
                            <div class="trusted-content">
        ...
        <div class="collection-tab-inner mt-0">
            <div class="container">
                <div class="grid-container-2">
                    <a class="grid-item grid-item-1 position-relative rounded mt-0 d-flex" href="/collection-left-sidebar"
                        data-aos="fade-right" data-aos-duration="700">
                        <img class="banner-img rounded" src="website/img/banner/f1.jpg" alt="banner-1">
                        <div class="content-absolute content-slide">
                    ...
                    <a class="grid-item grid-item-2 position-relative rounded mt-0 d-flex" href="/collection-left-sidebar"
                        data-aos="fade-right" data-aos-duration="700">
                        <img class="banner-img rounded" src="website/img/banner/f3.jpg" alt="banner-1">
                        <div class="content-absolute content-slide">
                    ...
                    <a class="grid-item grid-item-3 position-relative rounded mt-0 d-flex" href="/collection-left-sidebar"
                        data-aos="fade-left" data-aos-duration="700">
                        <img class="banner-img rounded" src="website/img/banner/f2.jpg" alt="banner-1">
                        <div class="content-absolute content-slide">
                            <div class="container height-inherit d-flex">
                                <div class="content-box banner-content p-4">
                                    <h2 class="heading_34 primary-color">Let’s buy <br>New Chair</h2>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/9.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/1.jpg"
                                        alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="/collection-left-sidebar">best wood furniture</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/10.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/2.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/11.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/3.jpg"
                                        alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="/collection-left-sidebar">Sarno Dining Chair</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/14.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/4.jpg"
                                        alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="/collection-left-sidebar">bisum tea table</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/15.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/5.jpg"
                                        alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="/collection-left-sidebar">Eliot Reversible tool</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/16.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/6.jpg"
                                        alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="/collection-left-sidebar">Vita Lounge wardrobe</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/17.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/7.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="/collection-left-sidebar">
                                    <img class="secondary-img" src="website/img/products/furniture/19.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="website/img/products/furniture/8.jpg"
                                        alt="product-img">
                                </a>
                            ...
                            <div class="product-card-details">
                                ...
                                <h3 class="product-card-title">
                                    <a href="/collection-left-sidebar">Vita Lounge Chair</a>
                                </h3>
                                <div class="product-card-price">
                                    <span class="card-price-regular">$1529</span>
                                    <span class="card-price-compare text-decoration-line-through">$1759</span>
            ...
            <div class="container">
                ...
                <div class="shop-category-2 shop-category-inner">
                    <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                        <div class="scattered-wrapper">
                            <div class="scattered-content">
                                <img class="scattered-img" src="website/img/banner/f4.jpg" alt="img">
                            </div>
                            <div class="scattered-details">
                                <h2 class="scattered-heading primary-color">Home Decor</h2>
                                <a href="/collection-left-sidebar"
                    ...
                    <div class="scattered-item" data-aos="fade-right" data-aos-duration="700">
                        <div class="scattered-wrapper">
                            <div class="scattered-content">
                                <img class="scattered-img" src="website/img/banner/f5.jpg" alt="img">
                            </div>
                            <div class="scattered-details">
                    ...
                    <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                        <div class="scattered-wrapper">
                            <div class="scattered-content">
                                <img class="scattered-img" src="website/img/banner/f6.jpg" alt="img">
                            </div>
                            <div class="scattered-details">
    ...
    <div class="video-section mt-100 overflow-hidden">
        <div class="overlay-furniture section-spacing"
            style="background: url('./website/img/video/video-furniture.jpg') no-repeat fixed bottom center/cover">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-reviewer d-flex align-items-center">
                                        <div class="reviewer-img">
                                            <img src="website/img/testimonial/john.jpg" alt="img">
                                        </div>
    ...
    <div class="single-banner-section mt-100 overflow-hidden">
        <div class="position-relative overlay">
            <img class="single-banner-img" src="website/img/banner/single-banner-2.jpg" alt="slide-1">
                    ...
                    <div class="common-slider" data-slick='{
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="/article">
                                    <img src="website/img/blog/furniture-1.jpg" alt="img"
                                ...
                                <h2 class="article-card-heading heading_18">
                                    <a class="heading_18" href="/article">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="/article">
                                    <img src="website/img/blog/furniture-2.jpg" alt="img"
                                        class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="/article">
                                    <img src="website/img/blog/furniture-3.jpg" alt="img"
                                        class="article-card-img rounded">
                        ...
                        <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                            <div class="article-card bg-transparent p-0 shadow-none">
                                <a class="article-card-img-wrapper" href="/article">
                                    <img src="website/img/blog/furniture-4.jpg" alt="img"
                                        class="article-card-img rounded">
                                    <span class="article-tag article-tag-absolute rounded">Furniture</span>
                                </a>
                                <p class="article-card-published text_12 d-flex align-items-center">
                ...
                <div class="brand-logo-container overflow-hidden">
                    <div class="scroll-horizontal row align-items-center flex-nowrap">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                            data-aos-duration="700">
                            <a href="/dashboardOne" class="brand-logo d-flex align-items-center justify-content-center">
                                <img src="website/img/brand/1.png" alt="img">
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                            data-aos-duration="700">
                            <a href="/dashboardOne" class="brand-logo d-flex align-items-center justify-content-center">
                                <img src="website/img/brand/2.png" alt="img">
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                            data-aos-duration="700">
                            <a href="/dashboardOne" class="brand-logo d-flex align-items-center justify-content-center">
                                <img src="website/img/brand/3.png" alt="img">
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                            data-aos-duration="700">
                            <a href="/dashboardOne" class="brand-logo d-flex align-items-center justify-content-center">
                                <img src="website/img/brand/4.png" alt="img">
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                            data-aos-duration="700">
                            <a href="/dashboardOne" class="brand-logo d-flex align-items-center justify-content-center">
                                <img src="website/img/brand/5.png" alt="img">
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                            data-aos-duration="700">
                            <a href="/dashboardOne" class="brand-logo d-flex align-items-center justify-content-center">
                                <img src="website/img/brand/6.png" alt="img">
                            </a>
                        </div>
                    </div>
                </div>
