    ...
    <main id="MainContent" class="content-for-layout">
          ...
          <div class="container">
            <div class="row justify-content-center trusted-row">
              <div class="col-lg-4 col-md-6 col-12">
                <div class="trusted-badge bg-4 rounded">
                  <div class="trusted-icon">
                    <img class="icon-trusted" src="assets/img/trusted/4.png" alt="icon-1">
                  </div>
              ...
              <div class="col-lg-4 col-md-6 col-12">
                <div class="trusted-badge bg-4 rounded">
                  <div class="trusted-icon">
                    <img class="icon-trusted" src="assets/img/trusted/6.png" alt="icon-3">
                  </div>
                  <div class="trusted-content">
          ...
          <div class="container">
            ...
            <div class="tab-list collection-tab-list">
              <nav class="nav justify-content-center">
                <a class="tab-link active" href="#collection-all" data-bs-toggle="tab">All</a>
                <a class="tab-link" href="#collection-tools" data-bs-toggle="tab">Tools</a>
                <a class="tab-link" href="#collection-cutter" data-bs-toggle="tab">Cutter</a>
                <a class="tab-link" href="#collection-saw" data-bs-toggle="tab">Saw</a>
              </nav>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          ...
                          <img class="primary-img" src="assets/img/products/tools/1.jpg" alt="product-img">
                        </a>
                    ...
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          ...
                          <img class="primary-img" src="assets/img/products/tools/2.jpg" alt="product-img">
                        </a>
                    ...
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          ...
                          <img class="primary-img" src="assets/img/products/tools/3.jpg" alt="product-img">
                        </a>
                    ...
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          ...
                          <img class="primary-img" src="assets/img/products/tools/4.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="primary-img" src="assets/img/products/tools/5.jpg" alt="product-img">
                        </a>
                    ...
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          ...
                          <img class="primary-img" src="assets/img/products/tools/6.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="primary-img" src="assets/img/products/tools/7.jpg" alt="product-img">
                        </a>
                    ...
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          ...
                          <img class="primary-img" src="assets/img/products/tools/8.jpg" alt="product-img">
                        </a>
                ...
                <div class="row">
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="secondary-img" src="assets/img/products/tools/34.jpg" alt="product-img">
                          <img class="primary-img" src="assets/img/products/tools/14.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="primary-img" src="assets/img/products/tools/15.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="secondary-img" src="assets/img/products/tools/36.jpg" alt="product-img">
                          <img class="primary-img" src="assets/img/products/tools/16.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="secondary-img" src="assets/img/products/tools/3.jpg" alt="product-img">
                          <img class="primary-img" src="assets/img/products/tools/9.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="secondary-img" src="assets/img/products/tools/19.jpg" alt="product-img">
                          <img class="primary-img" src="assets/img/products/tools/10.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="secondary-img" src="assets/img/products/tools/31.jpg" alt="product-img">
                          <img class="primary-img" src="assets/img/products/tools/11.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="secondary-img" src="assets/img/products/tools/32.jpg" alt="product-img">
                          <img class="primary-img" src="assets/img/products/tools/12.jpg" alt="product-img">
                        </a>
                  ...
                  <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                      <div class="product-card-img">
                        <a class="hover-switch" href="collection-left-sidebar.html">
                          <img class="primary-img" src="assets/img/products/tools/13.jpg" alt="product-img">
                        </a>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-6 col-md-6 col-12" data-aos="fade-right" data-aos-duration="1200">
                <a class="banner-item position-relative rounded" href="collection-left-sidebar.html">
                  <img class="banner-img" src="assets/img/banner/tools-1.jpg" alt="banner-1">
                  <div class="content-absolute content-slide">
                    <div class="container height-inherit d-flex align-items-center">
                      <div class="content-box banner-content p-4 text-center">
                        <p class="heading_18 text-white mb-3">Electric Drill</p>
                        <h2 class="heading_34 primary-color">25% off on <br>all drill</h2>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <div class="col-lg-6 col-md-6 col-12" data-aos="fade-left" data-aos-duration="1200">
                <a class="banner-item position-relative rounded" href="collection-left-sidebar.html">
                  <img class="banner-img" src="assets/img/banner/tools-2.jpg" alt="banner-2">
                  <div class="content-absolute content-slide">
                    <div class="container height-inherit d-flex align-items-center">
                      <div class="content-box banner-content p-4 text-center">
                        <p class="heading_18 text-white mb-3">Power Tools</p>
                        <h2 class="heading_34 primary-color">For power <br>users</h2>
                      </div>
                    </div>
                  </div>
                </a>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-lg-8 col-12 align-self-center">
              <div class="promotinal-product-container position-relative" data-aos="fade-left" data-aos-duration="1200">
          ...
          <div class="container">
            ...
            <div class="core-features-container">
              <div class="row justify-content-center g-0">
                <div class="col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-duration="300">
                  <div class="core-features">
                    <img src="assets/img/icon/core-features/1.png" alt="icon-core-features">
                    <h2 class="core-heading heading_24">All Kind Brand</h2>
                    <p class="core-text text_16">Lorem ipsum dolor sit ame it, the consectetur adipisicing elit, sed
                      eiusmod te mp or incididunt ut.</p>
                    <a href="about-us.html" class="core-link text_14 link-underline">Read more</a>
                  </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-duration="500">
                  <div class="core-features">
                    <img src="assets/img/icon/core-features/2.png" alt="icon-core-features">
                    <h2 class="core-heading heading_24">Expert Mechanic</h2>
                    <p class="core-text text_16">Lorem ipsum dolor sit ame it, the consectetur adipisicing elit, sed
                      eiusmod te mp or incididunt ut.</p>
                    <a href="about-us.html" class="core-link text_14 link-underline">Read more</a>
                  </div>
                ...
                <div class="col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-duration="800">
                  <div class="core-features">
                    <img src="assets/img/icon/core-features/3.png" alt="icon-core-features">
                    <h2 class="core-heading heading_24">Repair Vehicles</h2>
                    <p class="core-text text_16">Lorem ipsum dolor sit ame it, the consectetur adipisicing elit, sed
                      eiusmod te mp or incididunt ut.</p>
                    <a href="about-us.html" class="core-link text_14 link-underline">Read more</a>
                  </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-duration="1200">
                  <div class="core-features">
                    <img src="assets/img/icon/core-features/4.png" alt="icon-core-features">
                    <h2 class="core-heading heading_24">Paint & Costume</h2>
                    <p class="core-text text_16">Lorem ipsum dolor sit ame it, the consectetur adipisicing elit, sed
                      eiusmod te mp or incididunt ut.</p>
                    <a href="about-us.html" class="core-link text_14 link-underline">Read more</a>
                  </div>
      ...
      <div class="video-section mt-100 overflow-hidden">
        <div class="overlay-tools section-spacing"
          style="background: url('./assets/img/video/video-tools.jpg') no-repeat fixed bottom center/cover">
            ...
            <div class="article-card-container">
              <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                  <div class="article-card">
                    <a class="article-card-img-wrapper" href="article.html">
                      <img src="assets/img/blog/tools-1.jpg" alt="img" class="article-card-img rounded">
                    </a>
                    ...
                    <a class="article-card-read-more text_14 link-underline" href="article.html">Read More</a>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                  <div class="article-card">
                    <a class="article-card-img-wrapper" href="article.html">
                      <img src="assets/img/blog/tools-2.jpg" alt="img" class="article-card-img rounded">
                    </a>
                    <p class="article-card-published text_12">30 July 2022</p>
                    <h2 class="article-card-heading heading_18">
                      <a class="heading_18" href="article.html">
                ...
                <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                  <div class="article-card">
                    <a class="article-card-img-wrapper" href="article.html">
                      <img src="assets/img/blog/tools-3.jpg" alt="img" class="article-card-img rounded">
                    </a>
                    <p class="article-card-published text_12">30 July 2022</p>
                    <h2 class="article-card-heading heading_18">
                      <a class="heading_18" href="article.html">
        ...
        <div class="cart-content-area d-flex justify-content-between flex-column">
          ...
          <div class="minicart-footer">
            ...
            <div class="minicart-btn-area d-flex align-items-center justify-content-between">
              <a href="/cart" class="minicart-btn btn-secondary">View Cart</a>
