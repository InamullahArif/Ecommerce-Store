                        ...
                        <div class="announcement-meta d-flex align-items-center">
                            ...
                            <div class="currency-wrapper">
                                <button type="button" class="currency-btn btn-reset text-white"
                                    ...
                                    <img class="flag" src="{{asset('website/img/flag/usd.jpg')}}" alt="img">
                                    <span>USD</span>
                                    <span>
                                ...
                                <ul class="currency-list dropdown-menu dropdown-menu-end px-2">
                                    ...
                                    <li class="currency-list-item ">
                                        <a class="currency-list-option" href="#" data-value="CAD">
                                            <img class="flag" src="{{asset('website/img/flag/cad.jpg')}}" alt="img">
                                            <span>CAD</span>
                                        </a>
                                    </li>
                                    <li class="currency-list-item ">
                                        <a class="currency-list-option" href="#" data-value="EUR">
                                            <img class="flag" src="{{asset('website/img/flag/eur.jpg')}}" alt="img">
                                            <span>EUR</span>
                                        </a>
                                    </li>
                                    <li class="currency-list-item ">
                                        <a class="currency-list-option" href="#" data-value="JPY">
                                            <img class="flag" src="{{asset('website/img/flag/jpy.jpg')}}" alt="img">
                                            <span>JPY</span>
                                        </a>
                                    </li>
                                    <li class="currency-list-item ">
                                        <a class="currency-list-option" href="#" data-value="GBP">
                                            <img class="flag" src="{{asset('website/img/flag/gbp.jpg')}}" alt="img">
                                            <span>GBP</span>
                                        </a>
                                    </li>
                                </ul>
