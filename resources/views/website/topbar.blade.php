            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-4">
                    <div class="header-logo">
                        <a href="/dashboardOne" class="logo-main">
                            <img src="{{ asset('website/img/logo.png') }}" loading="lazy" alt="bisum">
                        </a>
                    </div>
                </div>
                        ...
                        <ul class="main-menu list-unstyled justify-content-center">
                            <li class="menu-list-item nav-item has-dropdown active">
                                <div class="mega-menu-header">
                                    <a class="nav-link" href="/dashboardOne">
                                        Home
                                    </a>
                                ...
                                <div class="submenu-transform submenu-transform-desktop">
                                    <ul class="submenu list-unstyled">
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/dashboardOne">Home</a>
                                        </li>
                                        {{-- <li class="menu-list-item nav-item-sub">
                                                    ...
                                                    <ul class="megamenu list-unstyled">
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                                                href="/collection-left-sidebar">With Left
                                                                Sidebar</a>
                                                        </li>
                                                        {{-- <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                            ...
                                            {{-- <li class="menu-list-item nav-item-sub">
                                                <div
                                                    ...
                                                    <a class="mega-menu-img nav-link-sub nav-text-sub"
                                                        href="collection-left-sidebar.html">
                                                        <img class="menu-img" src="website/img/menu/1.jpg" alt="img">
                            ...
                            <li class="menu-list-item nav-item has-dropdown">
                                ...
                                <div class="submenu-transform submenu-transform-desktop">
                                    <ul class="submenu list-unstyled">
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/blog">Blog</a>
                                        </li>
                                        {{-- <li class="menu-list-item nav-item-sub">
                            ...
                            <li class="menu-list-item nav-item has-dropdown">
                                ...
                                <div class="submenu-transform submenu-transform-desktop">
                                    <ul class="submenu list-unstyled">
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/about-us">About
                                                Us</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
