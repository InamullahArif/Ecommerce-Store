...
<body>
    <div class="body-wrapper">
        @include('website.announcement-bar')
        <x-website-navbar/>
        @yield('content')
        <x-website-footer/>
        <button id="scrollup">
                        ...
                        <ul class="main-menu list-unstyled">
                            ...
                            <li class="menu-list-item nav-item has-dropdown">
                                ...
                                <div class="submenu-transform submenu-transform-desktop">
                                    ...
                                    <ul class="submenu list-unstyled">
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/about-us">About Us</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/contact">Contact</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/faq">FAQ</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/404">404 page</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/login">Login</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/register">Register</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/wishlist">Wishlist</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/cart">Cart</a>
                                        </li>
                                        <li class="menu-list-item nav-item-sub">
                                            <a class="nav-link-sub nav-text-sub" href="/checkout">Checkout</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <ul class="utility-menu list-unstyled">
                        ...
                        <li class="utilty-menu-item">
                            <button type="button" class="currency-btn btn-reset" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img class="flag" src="website/img/flag/usd.jpg" alt="img">
                                <span>USD</span>
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <ul class="currency-list dropdown-menu dropdown-menu-end px-2">
                                ...
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="CAD">
                                        <img class="flag" src="website/img/flag/cad.jpg" alt="img">
                                        <span>CAD</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="EUR">
                                        <img class="flag" src="website/img/flag/eur.jpg" alt="img">
                                        <span>EUR</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="JPY">
                                        <img class="flag" src="website/img/flag/jpy.jpg" alt="img">
                                        <span>JPY</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="GBP">
                                        <img class="flag" src="website/img/flag/gbp.jpg" alt="img">
                                        <span>GBP</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="minicart-loop custom-scrollbar">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="website/img/products/furniture/1.jpg" alt="img">
                            </div>
                            <div class="product-info">
                                ...
                                <div class="misc d-flex align-items-end justify-content-between">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button class="qty-btn dec-qty"><img src="website/img/icon/minus.svg"
                                                alt="minus"></button>
                                        <input class="qty-input" type="number" name="qty" value="1" min="0">
                                        <button class="qty-btn inc-qty"><img src="website/img/icon/plus.svg"
                                                alt="plus"></button>
                                    </div>
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="website/img/products/furniture/2.jpg" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="website/img/products/furniture/3.jpg" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="website/img/products/furniture/4.jpg" alt="img">
                            </div>
                            <div class="product-info">
                                <h2 class="product-title"><a href="#">Vita Lounge Chair</a></h2>
                                <p class="product-vendor">XS / Dove Gray</p>
                                    ...
                                    <div class="product-img-large">
                                        <div class="qv-large-slider img-large-slider common-slider" data-slick='{
                                            ...
                                            <div class="img-large-wrapper">
                                                <img src="website/img/products/bags/39.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="website/img/products/bags/38.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="website/img/products/bags/37.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="website/img/products/bags/36.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="website/img/products/bags/34.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="website/img/products/bags/30.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="website/img/products/bags/32.jpg" alt="img">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-12">
                                <div class="product-details ps-lg-4">
                                    ...
                                    <div class="misc d-flex align-items-end justify-content-between mt-4">
                                        <div class="quantity d-flex align-items-center justify-content-between">
                                            <button class="qty-btn dec-qty"><img src="website/img/icon/minus.svg" alt="minus"></button>
                                            <input class="qty-input" type="number" name="qty" value="1" min="0">
                                            <button class="qty-btn inc-qty"><img src="website/img/icon/plus.svg" alt="plus"></button>
                                        </div>
