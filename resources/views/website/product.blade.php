                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-gallery product-gallery-vertical d-flex">
                            <div class="product-img-large">
                                <input type="hidden" id="first-product-image"
                                    value="{{ asset($products->images->first()->name) }}">
                                <div class="img-large-slider common-slider"
                                    ...
                                    @foreach ($products->images as $image)
                                        <div class="img-large-wrapper">
                                            <a href="website/img/products/bags/39.jpg" data-fancybox="gallery">
                                                <img src="{{ asset($image->name) }}" alt="img">
                                            </a>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-details ps-lg-4">
                            @php
                                ...
                                // dd($sum);
                            @endphp
                            <div class="mb-3"><span class="product-availability" id="stockk">
                                    @if ($sum > 0)
                                        In Stock
                                    @else
                                        Out of Stock
                            ...
                            <div class="product-price-wrapper mb-4">
                                <span class="product-price regular-price">{{ '$' . $products->price ?? '--' }}</span>
                            ...
                            <div class="product-variant-wrapper">
                                <div class="product-variant product-variant-color">
                                    ...
                                    <ul class="variant-list list-unstyled d-flex align-items-center flex-wrap"
                                        id="color-options">
                                        @php
                                            $uniqueColors = $products->quantities->unique('color_id');
                                        @endphp
                                        @foreach ($uniqueColors as $quantity)
                                            @php
                                                $color = App\Models\Color::find($quantity->color_id);
                                            @endphp
                                            <li class="variant-item">
                                                <input type="radio" name="color"  class="colorr" id="color-{{ $loop->index }}"
                                                    value="{{ $color->id }}" {{ $loop->first ? 'checked' : '' }}>
                                                <label for="color-{{ $loop->index }}" class="variant-label"
                                ...
                                <div class="product-variant product-variant-other">
                                    ...
                                    <ul class="variant-list list-unstyled d-flex align-items-center flex-wrap"
                                        id="size-options">
                                        @php
                                            $uniqueSizes = $products->quantities->unique('size_id');
                                        @endphp
                                        @foreach ($uniqueSizes as $quantity)
                                            @php
                                                $size = App\Models\Size::find($quantity->size_id);
                                            @endphp
                                            <li class="variant-item">
                                                <input type="radio" name="size" class="sizee" id="size-{{ $loop->index }}"
                                                    value="{{ $size->id }}">
                                                <label for="size-{{ $loop->index }}"
                                                    class="variant-label">{{ $size->name }}</label>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                                <div id="error-message" style="color: red; display: none;">Please select a size</div>
                            </div>

                            <div class="misc d-flex align-items-end justify-content-between mt-4">
                                <div class="quantity d-flex align-items-center justify-content-between">
                                    <button class="qty-btn dec-qty"><img src="{{ asset('website/img/icon/minus.svg') }}"
                                            alt="minus"></button>
                                    <input class="qty-input" type="number" name="qty" id="inc-dec" value="1"
                                        min="0">
                                    <button class="qty-btn inc-qty"><img src="{{ asset('website/img/icon/plus.svg') }}"
                                            alt="plus"></button>
                                </div>
                            ...
                            <div id="error-message1" style="margin-top:10px;display: none; color: red;">You cannot select more than the available quantity.</span></div>

                            {{-- <form class="product-form" action="#"> --}}
                            <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                @if ($sum > 0)
                                    <button type="submit"
                                        class="position-relative btn-atc btn-add-to-cart loader addCart" id="ff">ADD TO
                                        CART</button>
                                @else
                                    <button type="submit"
                                        class="position-relative btn-atc btn-add-to-cart loader addCart" disabled>OUT OF
                                        STOCK</button>
                                @endif
                                <a href="/wishlist" class="product-wishlist">
            ...
            <div class="container">
                ...
                <div class="tab-content product-tab-content">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12 col-12">
                                <div class="desc-content">
                                    <p class="text_16 mb-4">{{ $products->description->description }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="pshipping" class="tab-pane fade">
                        <div class="desc-content">
                            <p class="text_16 mb-4">{{ $products->description->shipping_returns }}</p>
                        </div>
                    </div>
                    <div id="pstyle" class="tab-pane fade">
                        <div class="desc-content">
                            <p class="text_16 mb-4">{{ $products->description->style_with }}</p>
                        </div>
                    </div>
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch"
                                            ...
                                            <img class="primary-img" src="{{ asset($product->images->first()->name) }}"
                                                alt="product-img" style="width:261px;height:278px">
                                        </a>

                                        <div class="product-card-action product-card-action-2">
                                            @if ($sum > 0)
                                                <a href="#" class="addtocart-btn btn-primary"
                                                    style="width: 278px;">ADD TO CART</a>
                                            @else
                                                <a href="#" class="addtocart-btn btn-primary"
                                                    style="width: 278px;">ADD TO CART</a>
                                            @endif
                                    ...
                                    <div class="product-card-details">
                                        <h3 class="product-card-title"><a
                                                href="/collection-left-sidebar">{{ $product->name ?? '--' }}</a>
                                        </h3>
...
<style>
    ...
    .variant-label.selected {
        border-color: black;
        /* or any color to indicate the selection */
    }
</style>
...
$(document).ready(function() {
    ...
    $('.sizee').on('click', function(e) {
        updateMaxQuantity();
    });
    $('#color-options').on('click', '.colorr', function(e) {
        console.log('color selected:', this.value);
        // Call your updateMaxQuantityColor function here
        updateMaxQuantityColor(); // Ensure this function is defined and accessible
    });
    function updateMaxQuantityColor() {
        ...
        if (selectedColor && selectedSize) {
            $.ajax({
                url: '/get-product-quantity-color',
                type: 'GET',
                data: {
                ...
                success: function(response) {
                    ...
                    maxQuantity = response.quantities[0].product_quantity;
                    console.log(maxQuantity);
                    $('.qty-input').attr('max', maxQuantity);
    ...
    function updateMaxQuantity() {
        ...
        if (selectedColor && selectedSize) {
            $.ajax({
                ...
                success: function(response) {
                    $('#color-options').empty(); // Clear existing colors
                $.each(response.colors, function(index, color) {
                    $('#color-options').append(`
                        <li class="variant-item">
                            <input type="radio" name="color" class="colorr" id="color-${index}"
                                   value="${color.id}" ${index === 0 ? 'checked' : ''}>
                            <label for="color-${index}" class="variant-label"
                                   style="background-color: ${color.name};"></label>
                        </li>
                    `);
                });
                ...
                {
                    $("#inc-dec").val(0);
                    $("#stockk").text("Out of Stock");
                }else
                {
                    $("#inc-dec").val(1);
                    $('#error-message1').hide();
                    $("#stockk").text("In Stock");
                }
                    $('.qty-input').attr('max', maxQuantity);
                    // $('#max-quantity').text(maxQuantity);
                }
    ...
    function validateQuantity() {
        var selectedQuantity = parseInt($('.qty-input').val());
        if (selectedQuantity > maxQuantity) {
            $('#error-message1').show();
            $('.qty-input').val(maxQuantity); // Set the value to maxQuantity if it exceeds the available stock
    ...
    $('.addCart').on('click', function(e) {
        ...
        var productImage = $('#first-product-image').val();
        var selectedSize = $('input[name="size"]:checked').val();
        if (!selectedSize) {
            $('#error-message').show();
            return false;
        ...
        var selectedColor = $('input[name="color"]:checked').val();
        var productQuantity = parseInt($('.qty-input').val());
        ...
        var productPrice = parseFloat("{{ $products->price }}");
        ...
        var existingItem = cart.find(item => item.id == productId && item.color == selectedColor && item.size == selectedSize);
    ...
    $(document).on('click', '.product-remove', function(e) {
        ...
        // console.log(cart);
        var updatedCart = cart.filter(item => !(item.id == productId && item.color == productColor && item.size == productSize));
