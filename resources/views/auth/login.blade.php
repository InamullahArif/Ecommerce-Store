            ...
            <div class="wrap-login-page">
                <div class="flex-grow flex flex-column justify-center gap30">
                    ...
                    <div class="login-box">
                        ...
                        <form class="form-login flex flex-column gap24" id="loginForm" name="loginForm" method="POST" enctype="multipart/form-data" action="{{ route('login123') }}">
                            @csrf 
                            ...
                            @foreach ($errors->all() as $error)
                                <p class="text-xs" style="color: #e53e3e;">{{ $error }}</p>
                            @endforeach
                          @endif
